...
public class MassaTest {
    ...
    void deveRetornarPrecoMassaMolho () {
        Massa pizza = new MolhoTomate(new MassaBase());
    ...
    void deveRetornarPrecoMassaMolhoMucarela () {
        Massa pizza = new Mucarela(new MolhoTomate(new MassaBase()));
    ...
    void deveRetornarPrecoMassaMolhoMucarelaCalabresa () {
        Massa pizza = new Calabresa(new Mucarela (new MolhoTomate(new MassaBase())));
    ...
    void deveRetornarPrecoMassaMolhoMucarelaPortuguesa () {
        Massa pizza = new Portuguesa (new Mucarela (new MolhoTomate(new MassaBase())));
    ...
    void deveRetornarPrecoMassaMolhoMucarelaQuatroQueijos () {
        Massa pizza = new QuatroQueijos (new Mucarela (new MolhoTomate(new MassaBase())));
    ...
    void deveRetornarPrecoMassaChocolate() {
        Massa pizza = new Chocolate(new MassaBase());
    ...
    void deveRetornarPrecoMassaChocolateMorango () {
        Massa pizza = new Morango (new Chocolate(new MassaBase()));
